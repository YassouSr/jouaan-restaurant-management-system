# Generated by Django 4.1.3 on 2023-04-23 08:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[['admin', 'Admin'], ['customer', 'Customer'], ['chef', 'Chef'], ['driver', 'Driver']], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[['cash', 'Cash'], ['edahabia', 'Edahabia Card'], ['visa', 'Visa Card'], ['paypal', 'Paypal']], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Plate',
